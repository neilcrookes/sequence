...
class SequenceBehavior extends ModelBehavior {
	 ...
	 *
	 * @return void
	 * @param object  $Model  Model object that method is triggered on
	 * @param array   $config (optional) Configuration options include:
	 */
	 ...
	 *
	 * @param object  $Model       Model object that method is triggered on
	 * @param array   $groupValues (optional) Array with group field => group values, used for conditions
	 ...
	 *
	 * @param object  $Model       Model object that method is triggered on
	 * @param array   $groupValues (optional) Array of group field => group value pairs
